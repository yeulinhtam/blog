        ...
        <ThemeProvider theme={theme}>
            <Grid container className={classes.root}>
                ...
                <Grid item lg={8} container justify="center" alignContent="center" className={classes.form}>
                    <Grid item lg={6} container direction="column" alignContent="center" spacing={3}>
                        <Grid item>
                            <Typography variant="h5" className={classes.titleLogin}>Sign in to Minimal</Typography>
                        </Grid>
                        <Grid item variant="body1">
                            <Typography className={classes.subTitleLogin}>Enter your details below.</Typography>
                        </Grid>
                        ...
                        <Grid item>
                            <Button variant="contained" color="primary" fullWidth className={classes.btnLogin}>Login</Button>
                        </Grid>
                        <Grid item container justify="center" alignItems="center">
                            <Typography>Don’t have an account? <Link underline="none" href="#" color="secondary">Get started</Link></Typography>
                        </Grid>
                    </Grid>
                </Grid>
            </Grid>
